...
```{r echo=FALSE, warning=FALSE, header=FALSE, results='asis'}
stargazer(null_mod, full_mod, header = FALSE,
          type = "latex",
         covariate.labels = c(
           "Owner", 
           "Profile", 
...
```{r, Like Distribution Across Profiles, warning=FALSE}
dbr <- d[Owner == "Brian"]
...
```{r, Match Distribution Across Owners, warning=FALSE}
dbr <- d[Owner == "Brian"]
...
```{r power analysis, echo=FALSE, warning=FALSE}
...
```{r plot_power, echo=FALSE, warning=FALSE}
# Plot the results
...
```{r matches_t_test, echo=FALSE, warning=FALSE}
...
```{r matches_regression, echo=FALSE, warning=FALSE, results='asis'}
...
```{r matches_regression_complex, echo=FALSE, warning=FALSE, results='asis'}
...
```{r likes_regression_complex, echo=FALSE, warning=FALSE, results='asis'}
...
```{r HTE_preprocessing, echo=FALSE, warning=FALSE}
...
# HTE by Owner
```{r HTE_owner_average, warning=FALSE}
...
```{r HTE_owner_anova, warning=FALSE}
...
```{r HTE_city_avg, warning=FALSE, include=TRUE}
...
```{r HTE_weeks_average, warning=FALSE}
#HTE by weeks
...
```{r HTE_weeks_anova, warning=FALSE}
# ANOVA for Likes
